...
dl_path ='//*[@id="Col1-1-HistoricalDataTable-Proxy"]/section/div[1]/div[2]/span[2]/a/span'
fre_path = '//*[@id="Col1-1-HistoricalDataTable-Proxy"]/section/div[1]/div[1]/div[3]/span/div/span/span'
url = 'https://finance.yahoo.com/quote/AAPL/history?p=AAPL'
browser.get(url)
frequency = srch_element(browser, fre_path, 10)
a = browser.find_element_by_xpath(fre_path)
print(a.text())
frequency.click()    
'''
